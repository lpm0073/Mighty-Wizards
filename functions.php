...
function html5blank_styles()
{
  ...
  wp_register_style('theme-responsive', get_template_directory_uri() . '/css/style-responsive.css', array(), '1.0', 'all');
  wp_enqueue_style('theme-responsive'); // Enqueue it!
  ...
  wp_enqueue_style('vertical-rhythm'); // Enqueue it!
